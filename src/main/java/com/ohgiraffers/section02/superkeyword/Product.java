...
public class Product {
    ...
    public Product(String code, String brand, String name, int price , Date manufacturingDate){
        ...
        super();
        /*필기. 아무 클래스도 상속받디 않았는데 super()키워드가 호출 가능
        ...
        *      모든 클래스는 Object 클래스의 후손이기 때문이다*/
        ...
        System.out.println("매개변수가 있는 Product 클래스의 생성자 호출됨.....");
    }
    ...
    public String getInfo(){
        return "Product [ code = "+this.code+", brand = "+this.brand+", name = "+this.name+", price = "+this.price+", manufacturingDate = "+manufacturingDate+"]";
    }
}
